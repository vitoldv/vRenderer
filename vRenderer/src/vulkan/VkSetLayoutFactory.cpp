...
void VkSetLayoutFactory::createLayoutDefinitions()
{
	...
	layoutDefinitions[DESC_SET_LAYOUT::POST_PROCESSING_FEATURES] = createDescriptorSetLayout(1, VK_SHADER_STAGE_FRAGMENT_BIT, VK_DESCRIPTOR_TYPE_UNIFORM_BUFFER, context);
